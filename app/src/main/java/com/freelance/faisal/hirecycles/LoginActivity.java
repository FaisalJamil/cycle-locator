...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "crossover@crossover.com:crossover"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Session Manager to store access token for this session
                ...
                new WebServiceCall(new WebServiceCall.OnResultReceived(){
                    public void onResult(String data){
                        try {
                            ...
                            accessToken = temp.getString("accessToken");
                            // Save access token for future use.
                            session.createLoginSession(accessToken);
                            // Staring MapsActivity
                            if (isTaskRoot()) {
                    ...
                    /* TODO get data set populated here from web service*/
                    }
                }).asyncPost(getString(R.string.server_url)+getString(R.string.login_url), postBody);
            } catch (Exception e) {
                e.printStackTrace();
            }
